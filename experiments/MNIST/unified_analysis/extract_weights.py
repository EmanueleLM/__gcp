...
if __name__ == "__main__":
    ...
    # save weights
    np.save('./results/{}_weights_npy/init_weights_acc-le-{}.npy'.format(topology, init_acc_le), init)
    np.save('./results/{}_weights_npy/fin_weights_acc-ge-{}.npy'.format(topology, fin_acc_ge), fin)