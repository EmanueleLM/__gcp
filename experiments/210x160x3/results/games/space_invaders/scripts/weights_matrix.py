...
def get_weights_matrix(adj_matrices,
    ...
    """
        ...
        input_shapes:list, list of input shapes i.e. the number of nodes in each layer. In our case
                           the right vector is [(210,160,3), (53,40,16), (27,20,32), (17280), (256), (6)]
    ...
    Speedup initial/final weights:
        ...
        input_shapes = [(210,160,3), (53,40,16), (27,20,32), (17280), (256), (6)]
        input_padded = [(214,164,3), (58,44,16), (27,20,32), (17280), (256), (6)]
    ...
    for i in range(len_params):
        ...
        if i == 0:  # in the initial layers we need to consider also the input nodes
            ...
            current_ = np.sum(adj_matrices[i], axis=-1)  # 8x8x3x16 -> 8x8x3
            
            s = (input_shapes[1][0]*input_shapes[1][1],  # 53x40
                 input_padded[0][0]*input_padded[0][1],  # 214x164
                 input_shapes[0][2])  # 3 channels
            ...
            for n in range(input_shapes[0][2]):
                for a in range(input_shapes[1][0]):
                    v_offset = a*stride*input_padded[0][1]  # vertical offset
                    for b in range(input_shapes[1][1]):
