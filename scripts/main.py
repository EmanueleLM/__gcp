...
if __name__ == '__main__':
    ...
    noise_stdev = 5e-3
    name_flat_file = 'results/experiments_150iters_popsize1000_var5e-3/flat.npy'
    name_adj_matrices = 'results/experiments_150iters_popsize1000_var5e-3/adj_'
    ...
    src_seeds = 'seeds/seeds_experiments_150iters_popsize1000_var5e-3.txt'
    dst_tree = 'results/experiments_150iters_popsize1000_var5e-3/tree'
